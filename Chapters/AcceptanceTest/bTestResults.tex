...
\begin{figure}[H]
  \centering
	...
	\caption{Step response for the vehicle, where the vehicle hits a downhill ramp after 5 seconds and hits flat terrain again after around 8 second.}
	\label{AccT8Dfig}
\end{figure}

The prototype has been tested in correlation with the requirements set for the prototype. 5 out
of 8 requirements were met during the test, where another two should be met, if it was possible to test.