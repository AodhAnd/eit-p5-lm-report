...
One available system for a start is the \emph{Games on Track GT-Position} system which is able to determine the lawn mower's position in space, see \secref{GoTDescription}.\\
%
