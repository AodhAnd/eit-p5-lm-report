...
When the servo rotate to a specific angle, it pulls an arm connected to a rotating cylinder, pushing the piston, seen in \figref{Brakes}, when it rotates. The piston pushes the brake pad closest to it and will thereby add friction to the brake disc, slowing down the rotation.
