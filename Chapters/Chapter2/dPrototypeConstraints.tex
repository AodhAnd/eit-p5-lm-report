...
As the lawn mower is supposed to work outside, it is important to consider that the grass could be moist, and that an electronic device can be affected by environmental issues. Even if the electrical part is waterproofed, there is a mechanical threat, a moist sensor could then warn the system to order the vehicle to get back in time. \todo{write about vehicle slip and get rid of threat}
...
The lawn movers path might not always be clear, there could be some garden tools, tables or chairs, or moving objects. The vehicle should be aware of what is in front of it at any time, to correct its path and get around the obstacle if necessary. To avoid this the sensor could be a pushing button to detect a solid object or an ultrasound detector if the object is fragile.
