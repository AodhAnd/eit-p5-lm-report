...
The Wireless module makes it possible to transmit the coordinates from the GoT system to the lawn mower. If the connection is disturbed, it should be detected, to ensure invalid position data is not used.
