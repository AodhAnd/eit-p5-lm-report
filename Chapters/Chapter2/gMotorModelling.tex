...
Newtons second law of motion for rotating systems is used in the mechanical model. In \figref{fig:MotorFreeBody} a diagram is displaying the different directions of the forces affecting the model, which is equal the Newtons second law of motion for rotating systems, as seen in \eqref{eq:mechanicalmodel}.
