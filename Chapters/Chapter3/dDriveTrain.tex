...
An equation extracted from \figref{fig:BlackBoxGearFreeBodyDiagram} is obtained:
\begin{flalign}\centering
...
A block diagram describing the drivetrain has been built. In the following section the drivetrains block diagram is combined with the motor's block diagram, seen in \figref{fig:motormodelBlock}.