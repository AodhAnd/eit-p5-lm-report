...
The simulation uses a first order model as described in the previous section, however, the gain and time constant are found by step testing, as documented in \appref{app:gainTest} and \appref{app:inertiaTest}.
