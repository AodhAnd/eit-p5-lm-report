...
By knowing how the velocity of the vehicle reacts to an applied voltage, it is possible to apply a control to it, see \secref{sec:velocityController}, and study the steering behavior of the vehicle.