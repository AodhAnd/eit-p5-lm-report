...
The occurring of stiction in in the start of the simulation- and measured step-response, has been eliminated to a certain degree, which makes it redundant.furthermore, even though the vehicle is moving at a velocity of $0 [m \cdot s^{-1}]$, the velocity is registered to be $0.04 [m \cdot s^{-1}]$, see why in \secref{Hallfiltering}. 
