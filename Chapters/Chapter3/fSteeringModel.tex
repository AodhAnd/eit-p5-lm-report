...
A step of 1670ms is sent through the PWM to the servo at 5 seconds, that makes the vehicle turn at a constant speed. This makes the angle variate linearly as seen on \figref{fig:plotVerificationSteeringPlant}, and fit the simulation of the model of plant.
