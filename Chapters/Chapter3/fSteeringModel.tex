...
\end{figure}
\todo{Plot instead of scatter and use only one dataset (the green one, without the disturbed data point) + legend southeast + Change title to `Steering step response with 1670 ms PWM signal' + shift test dataset to start at 0 as in the simulation + fix y axis unit}
