...
\begin{figure}[H]
  ...
  \caption{Plot of the plant simulation and real life test.}
  \label{fig:plotVerificationSteeringPlant}
\end{figure}

A step of 1670ms is sent through the PWM to the servo at 5 seconds, that makes the vehicle turn at a constant speed, making the angle variating linearly as seen on \figref{fig:plotVerificationSteeringPlant}.
