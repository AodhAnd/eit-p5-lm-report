...
From \eqref{eq:angleIntegrationLaplace}, the block diagram of the steering model on \figref{fig:basicSteeringModelKCombinated} can be extended, as seen on \figref{fig:steeringLineFollowingModel}.
