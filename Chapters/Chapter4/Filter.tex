...
In the specification for the Magnetometer \cite{HMC5883L}, the sampling rate is given to 75 \si{Hz}. A sampling rate of 106 \si{Hz} is desired, since this sampling rate would not effect the system by causing a delay. 
...
As seen on the figure a delay of approximately 0.03 ms occurs when utilizing the filter compared to the raw measured data. If the velocity of the vehicle is 1.4 \si{\frac{m}{s}} then the vehicle will have moved approximately 4.2 \si{cm}. 