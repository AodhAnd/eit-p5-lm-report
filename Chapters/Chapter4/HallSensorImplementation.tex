...
The difference between the two plots is that at constant speed, the time measured at each outputs is uneven on \figref{unfilteredHall}, and more even in \figref{filteredHall}. A flowchart of the implementation of the functions of the Hall sensors can be seen on \figref{hallFlowchart}.
