\chapter{Hall Sensors}\label{sec:hallFiltering}
...
The difference between the two plots is that at constant speed, the time measured at each outputs is uneven on \figref{unfilteredHall}, and more even in \figref{filteredHall}. 
