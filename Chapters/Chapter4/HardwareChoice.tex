...
\begin{minipage}{\linewidth}
      ...
      \begin{minipage}{0.65\linewidth}
          \begin{figure}[H]
              ...
              \caption{Illustration of a standard size SD card.} % http://elasticsheep.com/2010/01/reading-an-sd-card-with-an-atmega168/
              \label{SDcardpinout}
          \end{figure}
      \end{minipage}
...
A SDSC card will be use for the project, as it have a capacity and transfer speed that meets the requirements. The data will be saved, if the power is cut off. The last requirement, the connections to the microcontroller
