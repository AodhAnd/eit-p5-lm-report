...
The Arduino Mega 2560 is a 8-bit microcontroller (See \figref{}, which is a bigger version of the standard Arduino Uno. 

\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/ArdGenMega}
