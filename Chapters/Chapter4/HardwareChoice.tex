...
There are two H-bridges on the board, to control up to two motors. Since only one motor is used in this project, both of the two H-bridges will be used to power the motor. This results in a smaller current through the two H-bridges' transistors and therefore ensures a better protection of the system.
...
\todo{insert source - datasheet on Pololu dual VHN5019 motor driver}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
