...
A low-dropout type is chosen, L4941, to make sure it works, even at low battery voltages. This regulator has a maximum dropout of 700mV at 1A current, meaning that it will work with battery voltages as low as $\SI{5,7}{V}$. \todo{datasheet} 
...
\begin{figure}[H]
	...
	\label{i2clevel}
\end{figure}
\todo{Add a few sentences of explanations}
