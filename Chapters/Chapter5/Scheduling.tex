...
If the time allowed by the frequency sampling of the program is not large enough, or if some tasks need to be ran at a cerain time because of a sampling time, the data will be prioritized and run in the time allowed. An example of this case can be seen on \figref{roundRobinSchedule2}.
