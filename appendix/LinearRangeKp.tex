...
\subsubsection{Setup}
The setup is the same as in the steering gain test, see \appref{app:steeringOrderTest}.
...
\todo{Change graph : either the legends are wrong or the actual Kv calculations have to be made and plotted}
\begin{figure}[H]
  \centering
  %Trim margins @:   left        bottom       right       top
  \adjustbox{ trim = {.15\width} {.30\height} {.15\width} {.30\height}, clip }
