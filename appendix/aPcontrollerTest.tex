\chapter{Proportional controller test} %\label{put a label here and uncomment}
...
To test The test will be performed with an open loop (a step response), and with a Proportional controller, with and without feed forward.
...
To get as close as possible to the vehicle's exact gain, a test where the vehicle drives at different speed has been set up. In \figref{PconTest} the data from the performed test is illustrated. 
