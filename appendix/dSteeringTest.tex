...
The different steering time constants can be calculated thanks to the measurements tests. The value of \si{\tau} corresponds to the time when the angle reaches \si{63,2\%} of the final value. A plot of these test can be seen on \figref{plotStepResponseSteering}. 
...
As the test were made with a choosen gain \si{K = 1,5}, the gain related to the speed during the turning can be calculated:
