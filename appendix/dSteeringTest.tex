\pagebreak
\section{Steering Test} \label{app:steeringOrderTest}
\textbf{Name: Group 510}\\
\textbf{Date: 11/11 - 2015}

\subsection{Purpose}
The purpose of the test is to find the needed order of the steering model, and the gain related to the speed during the turning of the vehicle, with a PWM signal as an input and the vehicle's heading angle as an output.
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{figures/plotStepResponseSteering.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{figures/steeringPlotSpeedVsGain.pdf}
	\caption{Plot of the gain \si{K_v} against the real speed.}
	\label{steeringPlotSpeedVsGain}
\end{figure}

From this plot the linear gain can be established as
\begin{flalign}
