...
\input{Chapters/Chapter2/BatterySpecs} 			%---- Battery Specifications
\input{Chapters/Chapter2/aGoTdescription}
...
\input{Chapters/Chapter5/Scheduling}

%--------- Chapter 5 ----------------------------------------
\input{Chapters/Chapter5/sensorImplementation}
\input{Chapters/Chapter4/HallSensorImplementation}
\input{Chapters/Chapter5/magnetoImplementation}
...
\input{Chapters/Chapter4/gotFiltering} 			% GoT position filtering
\input{Chapters/Chapter4/Filter} 				% Magnetometer filtering


%%% Part 3 %%%
\part{Test \& Conclusion}

\input{Chapters/AcceptanceTest/AcceptanceTest}
\input{Chapters/AcceptanceTest/aTestProcedure}
\input{Chapters/AcceptanceTest/bTestResults}
...
%---------- Appendix C ---------------------------------------- Motor Tests - Generator Constant
\input{appendix/bMotorTest4.tex}

%---------- Appendix D ---------------------------------------- Motor Tests - Motor Constant
\input{appendix/bMotorTest5.tex}

%---------- Appendix E ---------------------------------------- Motor Tests - Friction
\input{appendix/bMotorTest6.tex}

%---------- Appendix F ---------------------------------------- Motor Tests - Moment of Inertia
\input{appendix/bMotorTest7.tex}

%---------- Appendix G ---------------------------------------- Motor Tests - Time Constant and Gain
\input{appendix/bMotorTest8.tex}

%---------- Appendix H ---------------------------------------- Magnetometer Calibration
\input{appendix/jMagnetoCalibration.tex}

%---------- Appendix I ---------------------------------------- Vehicle's Friction Test
\input{appendix/cFrictionTest.tex}

%---------- Appendix J ---------------------------------------- Vehicle's Inertia Test
\input{appendix/dInertiaTest.tex}

%---------- Appendix K ---------------------------------------- Vehicle's Velocity Gain Test
\input{appendix/GainTest.tex}

%---------- Appendix L ---------------------------------------- Velocity With P Controller Test
\input{appendix/aPcontrollerTest.tex}

%---------- Appendix M ---------------------------------------- Steering Test - K_steering
\input{appendix/dSteeringTest.tex}

%---------- Appendix N ---------------------------------------- Steering Test - Kp Linear Area
\input{appendix/LinearRangeKp.tex}

%---------- Appendix O ---------------------------------------- Schematics
